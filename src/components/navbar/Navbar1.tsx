...
const NavPart1 = () => {
  return (
    <div className='flex items-center gap-4'>
        ...
        <a href="#" className='text-gray-500 text-sm hover:text-amber-50' >Components</a>
        <a href="#" className='text-gray-500 text-sm hover:text-amber-50' >Pricing</a>
        <a href="#" className='text-gray-500 text-sm hover:text-amber-50' >Newsletter</a>
    </div>
  )
}
